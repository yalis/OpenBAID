...
class DjangoMandrillBackend(BaseEmailBackend):
    """
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(DjangoMandrillBackend, self).__init__(**kwargs)
        self.api_key = getattr(settings, "MANDRILL_API_KEY", None)
        self.api_url = MANDRILL_API_URL

        self.subaccount = getattr(settings, "MANDRILL_SUBACCOUNT_ERROR_EMAIL_REPORT", None)
